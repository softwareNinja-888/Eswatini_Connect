...
//   return (
//     <section className={`bg-gray-2 py-[60px] dark:bg-dark fixed top-0 right-0 z-100 ${isVisible ? '': 'hidden'}`}>
...
//               </p>
//             </div>
//             <button className="text-black hover:text-greenPrimary cursor-pointer" onClick={()=>{setIsVisible(false)}}>
//               <svg
//                 width={18}
//                 height={18}
//                 viewBox="0 0 18 18"
          ...
          <div className="mx-auto px-4 sm:container">
            <div className="relative flex max-w-[422px] items-center rounded-lg border border-stroke bg-white p-4 py-[18px] shadow-pricing-4 sm:px-[30px] dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark">
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <button
                  className="text-black hover:text-greenPrimary cursor-pointer"
