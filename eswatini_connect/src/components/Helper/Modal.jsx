...
export function FormModal(){
    ...
    return (
        <>
            ...
            <div id="contact_Btn" className="cursor-pointer flex border border-yellowCustom  text-white rounded-lg px-10 py-2 hover:bg-yellowCustom  hover:text-black transition duration-400 ease-in-out bg-black font-inter700 " onClick={()=>document.getElementById('my_modal_2').showModal()}>Let's Talk</div>
