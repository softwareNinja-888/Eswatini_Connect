export const DefaultColumn = ({ children }) => {
 ...
 export  const NameInput = ({width='w-90',name,setName}) => {
    return (
      <>
        <label  htmlFor="name" className='mb-[10px] block text-base font-inter600 text-white'>
          Name
        </label>
 ...
 export  const EmailInput = ({width='w-90',email,setEmail}) => {
    return (
      <>
        <label htmlFor="emailHeader" className='mb-[10px] block text-base font-inter600 text-white'>
          Email
        </label>
        <div className='relative'>
          <input
 ...
 export  const CompanyNameInput = ({width='w-90',companyName,setCompanyName}) => {
    return (
      <>
        <label htmlFor="companyNamelHeader" className='w-32 mb-[10px] block text-base font-inter600 text-white'>
          Company Name
        </label>
        <div className='relative'>
          <input
            type='text'
            id="companyNamelHeader"
            value={companyName}
 ...
 export  const StrongInput = () => {
  ...
  export const MessageTextarea = ({width='w-90',color='text-white', borderColor='border-white'}) => {
    return (
      <>
        <label htmlFor="messageHeader" className={`${color} mb-[10px] block text-base font-medium `}>
          Message
        </label>
        <div className='relative'>
          <textarea
